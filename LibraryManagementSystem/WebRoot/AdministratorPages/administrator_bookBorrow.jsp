...
<body>
<center>
<form method = "post" action = "administrator_actionbookBorrow.jsp" style="margin-top:100px">
<table bgColor="#c0c0c0">
<tr>
  <td colspan = "2" align="center" bgColor="#aedaaa" style=" width:400px; height:60px; font-size:35px;" >图书借阅</td>
</tr>
...
<tr>
  <td  colspan = "2"><center>
  <input class="btn" type = "submit" value ="借阅" style = "width:100px; height:30px;">
  </center>
  </td>
</tr>
</table>
