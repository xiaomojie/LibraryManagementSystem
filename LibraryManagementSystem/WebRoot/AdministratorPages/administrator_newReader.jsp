...
<html>
	...
	<body>
		...
		<center>
			<form method="post" action="administrator_actionnewReader.jsp">
				<table bgColor="#c0c0c0">
					...
					<%
						Connection dbConn = new ConnectDB().getdbConn();
						Statement statement = dbConn.createStatement();
						ResultSet resultSet = statement
								.executeQuery("select count(reader_id) as num from readers");
						String id = "";
						if (resultSet.next()) {
							id = String.valueOf(resultSet.getInt("num") + 1);
							int num = id.length();
					...
					<tr style="width: 100px; height: 30px; font-size: 20px;">
						...
						<td>
							<input type="date" name="day" value=<%=datetime%>>
						</td>
					</tr>
					<tr>
						<td colspan="2">
