...
<br/>
<center>
<form method = "post" action = "administrator_actionbookInto.jsp">
<table bgColor="#c0c0c0">
<tr>
  <td class = "head" colspan = "2" align="center" bgColor="#aedaaa" style=" width:400px; height:60px; font-size:35px;" >图书入库</td>
</tr>
...
<tr style=" width:100px; height:30px; font-size:20px;">
  <td>类别</td>
  <td >
     <select name = "category_id" style=" width:150px; height:25px;" class = "select">
